...
START TRANSACTION;
USE `mentormedb`;
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (1, 'admin', '$2a$10$9maigvA3lZsL1yNN9s8atOFM2rXFVklIEWRnpjoNSjBLIeKkt0PVO', 1, 'ADMIN', 'admin', 'admin', 'admin@admin.com', 'ADMIN. Password: admin', NULL);
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (2, 'guest', '$2a$10$9I75e7yFnlNZsGRXEqbu0uDdmg3/nJPDR1WBnCmmJWEwyf9jT25yC', 1, 'MENTEE', 'guest', 'guest', 'guest@guest.com', 'TEST MENTEE. Password: guest', NULL);
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (3, 'mentor', '$2a$10$rkWTrhpw16m5zkXuB0mckeg89qVkNgdGhikvtgyTZwKeVt4bJ8IgS', 1, 'MENTOR', 'mentor', 'mentor', 'mentor@mentor.com', 'TEST MENTOR, Password: mentor', NULL);
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (4, 'guest2', '$2a$10$7qxeNpy/eCNgV7ziJfwdBeAfUonT6L5CYNpMqe2BHeKEXLchX5ema', 1, 'MENTEE', 'guest2', 'guest2', 'guest2@guest2.com', 'TEST MENTEE, Password: guest2', NULL);
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (5, 'guest3', '$2a$10$5PtTmFu3QSsvGcx.MNqPZO2DHj0Wdlbt/QxviGdtDPNLxQBCYfV7K', 1, 'MENTEE', 'guest3', 'guest3', 'guest3@guest3.com', 'TEST MENTEE, Password: guest3', NULL);
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (6, 'guest4', '$2a$10$/X.2vkru9q98OhX6GYXeG.UJsNLj19PmWTopjBZ.AKU.5OWJnlVBq', 1, 'MENTEE', 'guest4', 'guest4', 'guest4@guest4.com', 'TEST MENTEE, Password: guest4', NULL);
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (7, 'guest5', '$2a$10$aMjZ2Z8T9Le4t1WSi//g3OFeyD7VDatU1.2QKRgtEWnZphOusgHWK', 1, 'MENTEE', 'guest5', 'guest5', 'guest5@guest5.com', 'TEST MENTEE, Password: guest5', NULL);
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (8, 'mentor2', '$2a$10$Vo6b9x3YlL8o1v3mP7zOtOZMJM1MHFteY.i2S.gKUqS0DEYRg3r3a', 1, 'MENTOR', 'mentor2', 'mentor2', 'mentor2@mentor2.com', 'TEST MENTOR, Password: mentor2', NULL);
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (9, 'mentor3', '$2a$10$ZcWEE9lmDkQulj6CyLaFv.2ttqb/dRnyjxHTvaf6Vd6u6I6xdc8km', 1, 'MENTOR', 'mentor3', 'mentor3', 'mentor3@mentor3.com', 'TEST MENTOR, Password: mentor3', NULL);
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (10, 'mentor4', '$2a$10$8W5FB.9EoY2mepmINnpqZunV870g1qDsgf78q6xFLvDfsxHVQsgC.', 1, 'MENTOR', 'mentor4', 'mentor4', 'mentor4@mentor4.com', 'TEST MENTOR, Password: mentor4', NULL);
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (11, 'mentor5', '$2a$10$K/kC1My8SxumjEaCnSSSNuebpPwCa4Fes2PRCqOMCen4qvy1bqx0i', 1, 'MENTOR', 'mentor5', 'mentor5', 'mentor5@mentor5.com', 'TEST MENTOR, Password: mentor5', NULL);
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (12, 'mentor6', '$2a$10$Y7jQvpBRvkEghhwS0YpexOZ0ISawwNfkp66IVwyW6v2nLesrfttMy', 1, 'MENTOR', 'mentor6', 'mentor6', 'mentor6@mentor6.com', 'TEST MENTOR, Password: mentor6', NULL);
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (13, 'mentor7', '$2a$10$.FukU1BkHPyeh3wtCsG1le2yJ3kVAs11YtZDcUdai4QUz4mc5VspS', 1, 'MENTOR', 'mentor7', 'mentor7', 'mentor7@mentor7.com', 'TEST MENTOR, Password: mentor7', NULL);
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (14, 'admin2', '$2a$10$/YjwdCvdsAjIoWSxttbU2OxhKNBYDMltDNSeFmzw2fsySz.yzh6Bu', 1, 'ADMIN', 'admin2', 'admin2', 'admin2@admin2.com', 'ADMIN2, Password: admin2', NULL);
