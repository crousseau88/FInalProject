...
START TRANSACTION;
USE `mentormedb`;
INSERT INTO `bootcamp` (`id`, `name`, `website`, `image_url`, `length_weeks`, `description`) VALUES (1, 'Skill Distillery', 'https://skilldistillery.com/', 'https://coursereport-production.imgix.net/uploads/school/logo/130/original/sd-logo.jpg?w=200&h=200&dpr=1&q=75', 16, 'The key is Java. Java is one of the most widely used programming languages and has been for over 15 years. Our parent company, Batky-Howell, has trained over 40,000 developers and has been teaching Java since it was introduced.  Leveraging this background we were able to create a unique curriculum that not only gives you greater job opportunities but also reduces your competition.');
