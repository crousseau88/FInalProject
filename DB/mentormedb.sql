...
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (2, 'guest', '$2a$10$9I75e7yFnlNZsGRXEqbu0uDdmg3/nJPDR1WBnCmmJWEwyf9jT25yC', 1, 'MENTEE', 'guest', 'guest', 'guest@guest.com', 'TEST MENTEE. Password: guest', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (3, 'mentor', '$2a$10$rkWTrhpw16m5zkXuB0mckeg89qVkNgdGhikvtgyTZwKeVt4bJ8IgS', 1, 'MENTOR', 'mentor', 'mentor', 'mentor@mentor.com', 'TEST MENTOR, Password: mentor', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (4, 'guest2', '$2a$10$7qxeNpy/eCNgV7ziJfwdBeAfUonT6L5CYNpMqe2BHeKEXLchX5ema', 1, 'MENTEE', 'guest2', 'guest2', 'guest2@guest2.com', 'TEST MENTEE, Password: guest2', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (5, 'guest3', '$2a$10$5PtTmFu3QSsvGcx.MNqPZO2DHj0Wdlbt/QxviGdtDPNLxQBCYfV7K', 1, 'MENTEE', 'guest3', 'guest3', 'guest3@guest3.com', 'TEST MENTEE, Password: guest3', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (6, 'guest4', '$2a$10$/X.2vkru9q98OhX6GYXeG.UJsNLj19PmWTopjBZ.AKU.5OWJnlVBq', 1, 'MENTEE', 'guest4', 'guest4', 'guest4@guest4.com', 'TEST MENTEE, Password: guest4', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (7, 'guest5', '$2a$10$aMjZ2Z8T9Le4t1WSi//g3OFeyD7VDatU1.2QKRgtEWnZphOusgHWK', 1, 'MENTEE', 'guest5', 'guest5', 'guest5@guest5.com', 'TEST MENTEE, Password: guest5', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (8, 'mentor2', '$2a$10$Vo6b9x3YlL8o1v3mP7zOtOZMJM1MHFteY.i2S.gKUqS0DEYRg3r3a', 1, 'MENTOR', 'mentor2', 'mentor2', 'mentor2@mentor2.com', 'TEST MENTOR, Password: mentor2', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (9, 'mentor3', '$2a$10$ZcWEE9lmDkQulj6CyLaFv.2ttqb/dRnyjxHTvaf6Vd6u6I6xdc8km', 1, 'MENTOR', 'mentor3', 'mentor3', 'mentor3@mentor3.com', 'TEST MENTOR, Password: mentor3', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (10, 'mentor4', '$2a$10$8W5FB.9EoY2mepmINnpqZunV870g1qDsgf78q6xFLvDfsxHVQsgC.', 1, 'MENTOR', 'mentor4', 'mentor4', 'mentor4@mentor4.com', 'TEST MENTOR, Password: mentor4', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (11, 'mentor5', '$2a$10$K/kC1My8SxumjEaCnSSSNuebpPwCa4Fes2PRCqOMCen4qvy1bqx0i', 1, 'MENTOR', 'mentor5', 'mentor5', 'mentor5@mentor5.com', 'TEST MENTOR, Password: mentor5', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (12, 'mentor6', '$2a$10$Y7jQvpBRvkEghhwS0YpexOZ0ISawwNfkp66IVwyW6v2nLesrfttMy', 1, 'MENTOR', 'mentor6', 'mentor6', 'mentor6@mentor6.com', 'TEST MENTOR, Password: mentor6', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (13, 'mentor7', '$2a$10$.FukU1BkHPyeh3wtCsG1le2yJ3kVAs11YtZDcUdai4QUz4mc5VspS', 1, 'MENTOR', 'mentor7', 'mentor7', 'mentor7@mentor7.com', 'TEST MENTOR, Password: mentor7', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
...
INSERT INTO `bootcamp_review` (`id`, `user_id`, `bootcamp_id`, `overall_rating`, `instructors_rating`, `curriculum_rating`, `job_assistance_rating`, `graduation_date`, `bootcamp_review`, `review_date`) VALUES (2, 3, 2, 5, 5, 5, 5, '2022-02-01', 'I had a great experience at Hack Reactor. I appreciated the preparation that was required before enrolling in the course because it gave me a chance to see if I like coding before committing to the immersive.', '2022-02-015 00:00:00');
...
INSERT INTO `bootcamp_advice` (`id`, `bootcamp_review_id`, `title`, `advice`) VALUES (2, 2, 'Succeeding at Hack Reactor', 'Be professional: - Treat this time like you’re on the job. This isn’t college. Don’t be obtuse. Don’t gossip. Show up prepared. Show respect. - Hack Reactor may literally give you a job if you prove yourself employable (Hacker in Residence program). The leaders of Hack Reactor can be your biggest advocates in the job search. Ask yourself — would your instructor vouch for you if a potential employer was to ask of their opinion? Would your cohort mates vouch for you?');
...
INSERT INTO `tool` (`id`, `bootcamp_advice_id`, `name`, `tool_type`, `why`, `website`, `notes`) VALUES (3, 2, '55\" Odyseey Ark 4k WideScreen Monitor', 'Monitor', 'You need screen real-estate. If not this, multiple monitors is a must!', 'https://www.samsung.com/us/computing/monitors/gaming/55-odyssey-ark-4k-uhd-165hz-1ms-quantum-mini-led-curved-gaming-screen-ls55bg970nnxgo/?cid=pla-ecomm-pfs-mon-us-google-na-03112022-170121-&ds_e=GOOGLE-cr:0-pl:295207915-&ds_c=FF~Monitors+SSC_CN~Monitors+SSC_ID~B0000PZN_PH~on_MK~us_BS~multi_PR~mon_SB~msmul_FS~hqloe_CA~smp_KS~nag_MT~na-&ds_ag=AG~Monitors+SSC_ID~E0001FZA_MK~us_AT~sa_MD~h_PK~roah_PB~google_AI~n_AE~oth1_TG~3mr_SA~res-&ds_k=PRODUCT_GROUP&gclid=CjwKCAjwm8WZBhBUEiwA178UnE3oLGwCGKPHaRXyZFF0lWcMkpqiH3zGv5b4P84VEwyUvDewsaO5gxoCPScQAvD_BwE&gclsrc=aw.ds', NULL);
