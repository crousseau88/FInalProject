...
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (2, 'grasshopper', '$2a$10$9I75e7yFnlNZsGRXEqbu0uDdmg3/nJPDR1WBnCmmJWEwyf9jT25yC', 1, 'MENTEE', 'Chad', 'Austin', 'guest@guest.com', 'First mentee on MentorMe! Can\'t wait to get to start my coding journey! ', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (3, 'sage', '$2a$10$rkWTrhpw16m5zkXuB0mckeg89qVkNgdGhikvtgyTZwKeVt4bJ8IgS', 1, 'MENTOR', 'Bill', 'Nye', 'mentor@mentor.com', 'First mentor on MentorMe! Proud SD graduate and passionate about setting up others for success through my lessons learned!', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
...
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (8, 'gandalf', '$2a$10$Vo6b9x3YlL8o1v3mP7zOtOZMJM1MHFteY.i2S.gKUqS0DEYRg3r3a', 1, 'MENTOR', 'Kirk', 'Hammet', 'mentor2@mentor2.com', 'Here to lend a hand to folks new to coding and looking for the bootcamp that\'s right for them. mentor2', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
...
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (11, 'braveheart', '$2a$10$K/kC1My8SxumjEaCnSSSNuebpPwCa4Fes2PRCqOMCen4qvy1bqx0i', 1, 'MENTOR', 'James', 'Hetfield', 'mentor5@mentor5.com', 'Pastry chef artist turned developer at 35 years old! Here to help your transition in a new career.', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (12, 'spiderman', '$2a$10$Y7jQvpBRvkEghhwS0YpexOZ0ISawwNfkp66IVwyW6v2nLesrfttMy', 1, 'MENTOR', 'Sammy', 'Hagar', 'mentor6@mentor6.com', 'High school graduate straight into a developer training.', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `first_name`, `last_name`, `email`, `about_me`, `profile_img`) VALUES (13, 'mrmiyagi', '$2a$10$.FukU1BkHPyeh3wtCsG1le2yJ3kVAs11YtZDcUdai4QUz4mc5VspS', 1, 'MENTOR', 'Alex', 'Vanhalen', 'mentor7@mentor7.com', 'NASA employee who got bored flying to the moon. Coder for life!', 'https://i.pinimg.com/564x/18/b9/ff/18b9ffb2a8a791d50213a9d595c4dd52.jpg');
...
START TRANSACTION;
USE `mentormedb`;
INSERT INTO `bootcamp` (`id`, `name`, `website`, `image_url`, `length_weeks`, `description`) VALUES (1, 'Skill Distillery', 'https://skilldistillery.com/', 'https://coursereport-production.imgix.net/uploads/school/logo/130/original/sd-logo.jpg?w=200&h=200&dpr=2&q=50', 16, 'The key is Java. Java is one of the most widely used programming languages and has been for over 15 years. Our parent company, Batky-Howell, has trained over 40,000 developers and has been teaching Java since it was introduced.  Leveraging this background we were able to create a unique curriculum that not only gives you greater job opportunities but also reduces your competition.');
...
INSERT INTO `tool` (`id`, `bootcamp_advice_id`, `name`, `tool_type`, `why`, `website`, `notes`) VALUES (10, 1, 'VeriDesk Essential 36', 'Desk', 'The adjustability of this desk has made a phenonminal change in my work day. Productivity is up and my headaches are down. I no longer have neck strain from tipping my head up to see the screen. The versatility of the VariDesk allows me to utilize the existing office desk and chair. All in all, the VariDesk Essential 36 is a work enhancing, money Read more about review stating VariDesk saved my necksaver for both the company and my chiropractor bills.', 'https://www.vari.com/sit-stand-converter-varidesk-essential-36/DC-EST36.html?gclid=CjwKCAjwvsqZBhAlEiwAqAHElUSSr9F1QV55jc-TDPbzUEGZtkHlrRck_v6xcnbwmwE-bS0eeN-Q4RoCyNoQAvD_BwE', NULL);
INSERT INTO `tool` (`id`, `bootcamp_advice_id`, `name`, `tool_type`, `why`, `website`, `notes`) VALUES (11, 3, 'Seagate Expansion 6TB External Hard Drive', 'Hard Drive', 'Overkill but you get the idea. If your hard drive is already topping out, you\'ll need extra space!', 'https://www.newegg.com/seagate-expansion-6tb-black/p/N82E16822184954?item=N82E16822184954&source=region&nm_mc=knc-googleadwords-pc&cm_mmc=knc-googleadwords-pc-_-pla-_-hard+drives+-+desktop+external-_-N82E16822184954&https://5bae6202cc7f172fac165e9a.c00.adobe.com/?a.deeplink.id=5fd111e3ff128fe5702819e2&ctxa.launch.campaign.trackingcode=iq1fqry5&id1=1658370898&id2=62634372126&id3=&id4=&id5=pla-1495071281957&id6=&id7=9023213&id8=&id9=g&id10=c&id11=&id12=CjwKCAjwvsqZBhAlEiwAqAHEldQ-S9nxpSQHDicK7jVnfQPLVKnWRO37C2W3jscMGvdBPU9rm4OkcBoCZZoQAvD_BwE&id13=&id14=Y&id15=&id16=319500424488&id17=&id18=&id19=&id20=&id21=pla&id22=8438988&id23=online&id24=N82E16822184954&id25=US&id26=1495071281957&id27=Y&id28=&id29=&id30=8179676785499697084&id31=en&id32=&id33=&id34=&gclid=CjwKCAjwvsqZBhAlEiwAqAHEldQ-S9nxpSQHDicK7jVnfQPLVKnWRO37C2W3jscMGvdBPU9rm4OkcBoCZZoQAvD_BwE', NULL);
INSERT INTO `tool` (`id`, `bootcamp_advice_id`, `name`, `tool_type`, `why`, `website`, `notes`) VALUES (12, 3, 'Crusader Industries Mousepad', 'Goliath Mousepad', 'Even workspace and a clean, non-slip surface from keyboard to mouse is a gamechanger! ', 'https://robertsspaceindustries.com/pledge/Crusader-Industries-Goliath-Mousepad-Ion/Mousepad', NULL);
INSERT INTO `tool` (`id`, `bootcamp_advice_id`, `name`, `tool_type`, `why`, `website`, `notes`) VALUES (13, 4, 'VHBW USB Charging Hub Station', 'USB Charger', 'Wireless headset, wireless mouse, wireless keyboard... you have to keep them charged and sometimes you need to charge them at the same time. If your computer has enough ports, you\'re set. If not, I recommend this hub!', 'https://www.amazon.com/VHBW-Charging-Station-Multiple-Extension/dp/B07PGRG73K/ref=sr_1_1_sspa?gclid=CjwKCAjwvsqZBhAlEiwAqAHEleCTrBXVFeazlE-tF-zoWhJ7BzPdRm6Yj3uv4Pw9GUnwZUaU3IXAGRoCdogQAvD_BwE&hvadid=174247278902&hvdev=c&hvlocphy=9023213&hvnetw=g&hvqmt=e&hvrand=14944238824580386317&hvtargid=kwd-12338255827&hydadcr=19106_9441139&keywords=usb+charging+hub&qid=1664296017&qu=eyJxc2MiOiI2LjExIiwicXNhIjoiNS44NSIsInFzcCI6IjUuNjUifQ%3D%3D&sr=8-1-spons&psc=1&spLa=ZW5jcnlwdGVkUXVhbGlmaWVyPUEyMzVQTFFaOEVIVEY2JmVuY3J5cHRlZElkPUEwODk5MzUzMjZIMUkzNUVFRE1RSCZlbmNyeXB0ZWRBZElkPUEwMjk3Mjk0MTU2VTlUTFhYT0RRMiZ3aWRnZXROYW1lPXNwX2F0ZiZhY3Rpb249Y2xpY2tSZWRpcmVjdCZkb05vdExvZ0NsaWNrPXRydWU=', NULL);
INSERT INTO `tool` (`id`, `bootcamp_advice_id`, `name`, `tool_type`, `why`, `website`, `notes`) VALUES (14, 4, 'Lume Cube Monitor Light Bar', 'Monitor Light Bar', 'You\'re going to get A LOT of screen time. This light monitor can reduce eye strain.', 'https://lumecube.com/products/monitor-light-bar?currency=USD&utm_medium=cpc&utm_source=google&utm_campaign=Google%20Shopping&nbt=nb%3Aadwords%3Ax%3A18280645193%3A%3A&nb_adtype=pla&nb_kwd=&nb_ti=&nb_mi=123218058&nb_pc=online&nb_pi=shopify_US_6844122431545_40579707207737&nb_ppi=&nb_placement=&nb_si={sourceid}&nb_li_ms=&nb_lp_ms=&nb_fii=&nb_ap=&nb_mt=&utm_source=google&utm_medium=paid&utm_campaign=18280645193&utm_content=&utm_term=&gadid=&gclid=CjwKCAjwvsqZBhAlEiwAqAHElYQofiZJL-SwOkmXlUikFO__eC68YZ62LPRaq8Dc8NcxQ8mMsY5OMhoCA1IQAvD_BwE', NULL);
INSERT INTO `tool` (`id`, `bootcamp_advice_id`, `name`, `tool_type`, `why`, `website`, `notes`) VALUES (15, 5, 'FeziBo Tripple Motor L-Shaped Standing Desk', 'Standing Desk', 'Game changer so you don\'t have to sit for 10+ hours a day! Highly recommend!', 'https://www.fezibo.com/products/triple-motor-l-shaped-corner-ergonomic-standing-desk-fezibo?variant=39895562944581&utm_source=google&utm_medium=cpc&utm_campaign=L-shaped-pmax&gclid=CjwKCAjwvsqZBhAlEiwAqAHElWwfFaN9-5aiLRpSO8yK86r50eqb4LjpYO9fTCCYJ0Kh-R_B1yGNwRoC7vMQAvD_BwE#/', NULL);
INSERT INTO `tool` (`id`, `bootcamp_advice_id`, `name`, `tool_type`, `why`, `website`, `notes`) VALUES (16, 6, 'SMUG Home Office Chair', 'Ergonomic Chair', 'Investing in a quality chair is a month for your long-term health. This may not be the chair for you but it worked for me. Get out their and take some chairs on a test drive before buying!', 'https://www.amazon.com/dp/B09PFS8848?pd_rd_i=B09PFS8848&pf_rd_p=7e505763-fc2b-4771-871e-c8789cf7e144&pf_rd_r=9SF7NPGH28TTNPDZPQEN&pd_rd_wg=8pzNf&pd_rd_w=vZbDM&pd_rd_r=072ce7c8-4c5c-4a5e-9b3f-93f04ee9a1fd', NULL);
INSERT INTO `tool` (`id`, `bootcamp_advice_id`, `name`, `tool_type`, `why`, `website`, `notes`) VALUES (17, 1, 'TUBBZ Metal Gear Solid Rubber Duck', 'Rubber Duck', 'Sometimes just saying the problem out loud makes the solution present itself! If no one is available to be your \"rubber duck\", this \"tool\" will be. Get to know it, talk to it often and you too will become a professional programmer!', 'https://www.amazon.com/TUBBZ-Metal-Collectible-Rubber-Figurine/dp/B08GKN1HYD/ref=asc_df_B08GKN1HYD/?tag=hyprod-20&linkCode=df0&hvadid=459667108255&hvpos=&hvnetw=g&hvrand=657101090268558108&hvpone=&hvptwo=&hvqmt=&hvdev=c&hvdvcmdl=&hvlocint=&hvlocphy=9023213&hvtargid=pla-957098104972&psc=1', NULL);
